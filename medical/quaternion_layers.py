...
class QuaternionLinear(Module):
    ...
    def __init__(self, in_features, out_features, bias=True,
        ...
        nn.init.uniform_(self.i_weight)
        nn.init.uniform_(self.j_weight)
        nn.init.uniform_(self.k_weight)
